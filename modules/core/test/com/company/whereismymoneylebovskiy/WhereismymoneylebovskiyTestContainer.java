package com.company.whereismymoneylebovskiy;
...
public class WhereismymoneylebovskiyTestContainer extends TestContainer {

    public WhereismymoneylebovskiyTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/whereismymoneylebovskiy/app.properties",
    ...
    public static class Common extends WhereismymoneylebovskiyTestContainer {

        public static final WhereismymoneylebovskiyTestContainer.Common INSTANCE = new WhereismymoneylebovskiyTestContainer.Common();
